          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all duration-300 border border-purple-100">
            <div className="flex flex-col items-center space-y-6 text-center sm:text-left">
              ...
              <div className="flex space-x-8">
                <a 
                  href="https://www.instagram.com/svasam_life?igsh=bDdwd2I1bmhrajVt"
                  target="_blank"
                ...
                <a 
                  href="https://youtube.com/@svasam_life?si=L-mBASkDNpg7OfwA"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a 
                  href="https://www.facebook.com/share/1Eb9FM6Zb4/?mibextid=wwXIfr"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a 
                  href="https://www.linkedin.com/company/svasam/"
                  target="_blank"
                  rel="noopener noreferrer"
