    ...
    <section className="py-12 px-4 max-w-6xl mx-auto" id="sessions">
      ...
      <div className="grid md:grid-cols-3 gap-8">
        {events.map((event, idx) => (
          <div key={idx} className="bg-white rounded-2xl shadow-lg p-6 flex flex-col gap-2 border border-indigo-100">
            ...
            <button className="mt-4 px-4 py-2 bg-indigo-500 text-white rounded-lg hover:bg-indigo-600 transition">Book Now</button>
          </div>
        ))}
      </div>
    </section>
