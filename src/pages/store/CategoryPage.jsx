...
export default function CategoryPage({ title }) {
  ...
  const { items, loading, error } = useStoreItems(title);
    ...
    return (
      <div className="min-h-screen w-full bg-background flex items-center justify-center">
        <div className="text-red-500 text-center p-4 max-w-md">
          <h2 className="text-xl font-bold mb-2">Error Loading {title}</h2>
    ...
    <div className="min-h-screen w-full bg-background">
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#8e6192]">{title}</h1>
        </div>
            ...
            {items.map((item) => (
              ...
              >
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <div className="mt-4">
                    <button
                      className="w-full px-4 py-2 bg-main text-white rounded-lg font-semibold text-sm shadow hover:brightness-105 focus:outline-none focus:ring-2 focus:ring-main focus:ring-offset-2 transition"
