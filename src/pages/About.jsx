  ...
  return (
    <div className="min-h-screen w-full bg-pink-50">
      <div className="max-w-4xl mx-auto py-16 px-4">
        <h1 className="text-4xl font-bold text-indigo-800 text-center mb-12">About Svasam</h1>
        ...
        <div className="space-y-8">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                <h3 className="text-xl font-semibold text-green-700 mb-2">Body Wellness</h3>
                <ul className="list-disc ml-6 text-gray-600 space-y-2">
              ...
              <div>
                <h3 className="text-xl font-semibold text-purple-700 mb-2">Soul Wellness</h3>
                <ul className="list-disc ml-6 text-gray-600 space-y-2">
              ...
              <div>
                <h3 className="text-xl font-semibold text-yellow-700 mb-2">Store & Resources</h3>
                <ul className="list-disc ml-6 text-gray-600 space-y-2">
          ...
          {/* Our Philosophy */}
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h2 className="text-2xl font-bold text-indigo-800 mb-4">Our Philosophy</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold text-indigo-700 mb-2">Holistic Approach</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-green-700 mb-2">Personalized Solutions</h3>
                <p className="text-gray-600">
                  Each person's journey is unique. That's why we offer customized wellness plans tailored to your specific needs and goals.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-purple-700 mb-2">Ancient Wisdom</h3>
                <p className="text-gray-600">
              ...
              <div>
                <h3 className="text-xl font-semibold text-yellow-700 mb-2">Community Support</h3>
                <p className="text-gray-600">
          ...
          {/* Contact & Join Us */}
          <div className="bg-white rounded-xl shadow-lg p-8">
            <h2 className="text-2xl font-bold text-indigo-800 mb-6">Join Our Wellness Journey</h2>
