const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/browser-C1N6upAF.js","assets/react-DTNW3hFM.js"])))=>i.map(i=>d[i]);
...
function printWarnings(config2 = {}) {
  const seen2 = {}, shouldIgnoreWarning = (message) => config2.ignoreWarnings === void 0 ? false : (Array.isArray(config2.ignoreWarnings) ? config2.ignoreWarnings : [config2.ignoreWarnings]).some((pattern) => typeof pattern == "string" ? message.includes(pattern) : pattern instanceof RegExp ? pattern.test(message) : false);
  return {
    onResponse: (res) => {
      const warn = res.headers["x-sanity-warning"], warnings = Array.isArray(warn) ? warn : [warn];
      for (const msg of warnings)
        !msg || seen2[msg] || shouldIgnoreWarning(msg) || (seen2[msg] = true, console.warn(msg));
      return res;
    }
  };
}
...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        __vitePreload(() => import("./stegaEncodeSourceMap-a9urfk4g.js"), true ? [] : void 0).then(function(n2) {
...
const pick = (obj, props) => props.reduce((selection, prop) => (typeof obj[prop] > "u" || (selection[prop] = obj[prop]), selection), {}), eventSourcePolyfill = defer(() => __vitePreload(() => import("./browser-C1N6upAF.js").then((n2) => n2.b), true ? __vite__mapDeps([0,1]) : void 0)).pipe(
